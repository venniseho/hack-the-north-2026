...
const statusClasses: Record<RiskStatus, string> = {
  ...
  medium:
    'border-amber-200 bg-amber-50 text-amber-800 dark:border-amber-700/70 dark:bg-amber-950/70 dark:text-amber-200',
  high: 'border-rose-200 bg-rose-50 text-rose-800 dark:border-rose-700/70 dark:bg-rose-950/70 dark:text-rose-200',
  unknown:
